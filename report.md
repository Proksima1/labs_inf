...
```
7. **Замечания автора** -
8. **Выводы**: Мне понравилась данная работа, потому что git очень важная часть в работе любого программиста, и он всегда будет актуален. Пока я выполнял данную лабораторную работу, я научился работать в консоле bash, а также изучать и находить информацию в различных источниках.
